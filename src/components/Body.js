...
export default function Body() {
  ...
  const Active1=()=>{
    ...
    document.getElementById('reebook1').style.setProperty('display', 'flex', 'important');
  ...
  const Active3=()=>{
    ...
    document.getElementById('puma1').style.setProperty('display', 'none', 'important');
    document.getElementById('reebook1').style.setProperty('display', 'none', 'important');
    document.getElementById('adidas1').style.setProperty('display', 'flex', 'important');
    ...
    <>
      <div className="container my-5 ">
        ...
        <div className="products d-flex justify-content-center my-5 row">
          ...
          <Products image={img5} image5={img5} title={Pumaname + " " + 1} title5={Pumaname + " " + 1} price1="2,499" price2="999" cart="five"/>
          <Products image={img6} image6={img6} title={Pumaname + " " + 2} title6={Pumaname + " " + 2} price1="2,499" price2="999" cart="six"/>
          <Products image={img7} image7={img7} title={Pumaname + " " + 3} title7={Pumaname + " " + 3} price1="2,499" price2="999" cart="seven"/>
          <Products image={img8} image8={img8} title={Pumaname + " " + 4} title8={Pumaname + " " + 4} price1="2,499" price2="999" cart="eight"/>
          </div>
          <div id="adidas1" className="third-row row d-flex justify-content-center ">
          <Products image={img9} image9={img9} title={AdidasName + " " + 1} title9={AdidasName + " " + 1} price1="1,499" price2="799" cart="nine"/>
          <Products image={img10} image10={img10} title={AdidasName + " " + 2} title10={AdidasName + " " + 2} price1="1,499" price2="799" cart="ten"/>
          <Products image={img11} image11={img11} title={AdidasName + " " + 3} title11={AdidasName + " " + 3} price1="1,499" price2="799" cart="eleven"/>
          <Products image={img12} image12={img12} title={AdidasName + " " + 4} title12={AdidasName + " " + 4} price1="1,499" price2="799" cart="twelve"/>
          </div>
          <div id="reebook1" className="fourth-row row d-flex justify-content-center ">
          <Products image={img13} image13={img13} title={ReebookName + " " + 1} title13={ReebookName + " " + 1} price1="1,999" price2="899" cart="thirteen"/>
          <Products image={img14} image14={img14} title={ReebookName + " " + 2} title14={ReebookName + " " + 2} price1="1,999" price2="899" cart="fourteen"/>
          <Products image={img15} image15={img15} title={ReebookName + " " + 3} title15={ReebookName + " " + 3} price1="1,999" price2="899" cart="fifteen"/>
          <Products image={img16} image16={img16} title={ReebookName + " " + 4} title16={ReebookName + " " + 4} price1="1,999" price2="899" cart="sixteen"/>
          </div>
        </div>
      </div>
    </>
